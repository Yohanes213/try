from scripts.data_processing.database_operations import get_db_connection, fetch_raw_data, store_cleaned_data
from scripts.data_processing.preprocess import clean_document
import os
...
if __name__ == "__main__":
    ...
    clean_data(raw_db_params, raw_table_name, clean_db_params, clean_table_name)
